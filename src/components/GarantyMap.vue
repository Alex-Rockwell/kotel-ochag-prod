      ...
      <div class="shops__text-container">
        ...
        >
          ...
          <div class="adress-box">
            <div class="phone-box">
              <a class="shopPhone" :href="`tel:${el.shopPhone}`">
                {{ el.shopPhone }}</a
              >
              <a
                v-if="el.shopPhone2"
                class="shopPhone"
                :href="`tel:${el.shopPhone2}`"
              >
                {{ el.shopPhone2 }}</a
              >
            </div>
...
import CustomSelectMapGaranty from "./CustomSelectMapGaranty.vue";
...
const coords = ref([54.356062, 48.592407]);

const markerText = ref("ООО «СервисГаз»");
