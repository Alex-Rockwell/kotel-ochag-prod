<template>
  <header class="header">
    <div class="container">
      <div class="header__wrapper">
        ...
        <nav class="header__nav">
          <ul class="header__list" :class="{ footer__list_active: isActive }">
            <li
              class="header__item"
              :class="{ activeLink: activeLink == 'about' }"
            >
              <RouterLink to="/about" class="header__link" @click="getActive()">
                О компании
              </RouterLink>
            </li>
            <li
              class="header__item"
              :class="{ activeLink: activeLink == 'catalog' }"
            >
              <RouterLink
                to="/catalog"
                class="header__link"
            ...
            <li
              class="header__item"
              :class="{ activeLink: activeLink == 'clients' }"
            >
              <RouterLink
                to="/clients"
                class="header__link"
            ...
            <li
              class="header__item"
              :class="{ activeLink: activeLink == 'garanty' }"
            >
              <RouterLink
                to="/garanty"
                class="header__link"
            ...
            <li
              class="header__item"
              :class="{ activeLink: activeLink == 'contacts' }"
            >
              <RouterLink
                to="/contacts"
                class="header__link"
            ...
            <li class="header__item">
              <a
                href="tel:88003330082"
                class="header__call header__call_hamburger"
                >8 800 333 51 03</a
              >
            </li>
          </ul>
        </nav>
        <a href="tel:88003330082" class="header__call header__call_basic">
          <marquee behavior="scroll" direction="left" scrollamount="7"
            >8 800 333 51 03</marquee
          >
          <span class="header__call-number">8 800 333 51 03</span>
        </a>
        <a href="tel:88003330082" class="header__phone">
          <div class="header__phone-inside"></div>
        </a>
      </div>
    </div>
    <div class="header__hamburger-wrapper">
      <div
        ...
        :class="{ header__hamburger_active: isActive }"
  ...
  <div class="container">
    <div
      v-if="activeLink != 'home' && activeLink != 'about'"
      class="banner-logo"
    >
      <img
        src="../../assets/images/logo-ochag-header.svg"
        alt="logo"
        class="banner-logo__img"
      />
    </div>
  </div>
</template>
...
.header
    ...
    box-shadow: 0px 2px 4px rgba(71, 120, 165, 0.22)
    &__wrapper
        display: flex
    ...
    &__call
        ...
        line-height: 29px
        @media (min-width: 991px)
            &:hover .header__call-number
                color: $blue
            &:active .header__call-number
                opacity: 0.5
        &_hamburger
            display: none
        marquee
    ...
    &__phone
        ...
        &::after
            ...
            width: 29px
            height: 29px
            background: url("../../assets/images/icon-phone-red.svg") center no-repeat
            ...
            &:hover
                .header__phone-inside
                    ...
                    &::before
                        ...
                        animation: headerPhone 1.8s linear infinite
                        cursor: pointer
                        opacity: 0
                        z-index: 1000
                    &::after
