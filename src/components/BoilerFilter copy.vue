<template>
  <section class="boiler container" id="homeBoiler">
    <h2 class="boiler__title centered mb">Бытовые отопительные котлы Очаг</h2>
    <ul class="tabheader">
      <li
    ...
    <div class="boiler-container">
      ...
      <div class="boiler-container-part2">
        <RouterLink
          :to="`/catalog/${filteredElement.seoTitle}`"
          class="link"
      ...
      <div class="boiler-container-part3">
        <ul class="heat__list">
          <li class="heat__item">
            <span class="heat__t1">Работает без электричества</span>
            <span class="heat__t2">Подключение к электросети не требуется</span>
          </li>
        </ul>
        <!-- <ul class="heat__list">
          <li class="heat__item">
          ...
          <li class="heat__item">
            <span class="heat__t1">Сталь 3 мм.</span>
            <span class="heat__t2">От надёжных российских производителей</span>
          </li>
          <li class="heat__item">
            <span class="heat__t1"
              >Подходит для систем с естественной и принудительной
              циркуляцией</span
            >
          </li>
          <li class="heat__item">
            <span class="heat__t1">Европейские комплектующие</span>
            <span class="heat__t2"
              >Газовая автоматика SIT — Италия Контрольно-измерительные приборы
              CEWAL — Италия</span
            >
          </li>
          <li class="heat__item">
            <span class="heat__t1"
              >Атмосферная горелка из нержавеющей стали</span
            >
          </li>
          <li class="heat__item">
            <span class="heat__t1">Срок службы 15 лет</span>
          </li>
        </ul> -->
      </div>
    </div>
      ...
      <div class="boiler-container-part3-2">
        <div class="text-container-2">
          ...
          <div class="boiler__name-box">
            ...
            <div class="boiler__name-box-r">
              <p class="product__price">{{ filteredElement.price }} &#8381;</p>
              <button class="product__btn-order" @click="openModal">Заказать</button>
              <RouterLink class="product__link" to="/clients"  
                >Где купить?</RouterLink
              >
            </div>
    ...
    <div class="boiler-container-3" >
      ...
      <div class="boiler-container-part1-2 boiler-container-part1-3">
        <ul class="heat__list heat__list-3">
          <li class="heat__item">
            <span class="heat__t1">Работает без электричества</span>
            <span class="heat__t2">Подключение к электросети не требуется</span>
          </li>
