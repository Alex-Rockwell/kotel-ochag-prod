<template>
  <section class="companyPage">
    <div class="container">
      <a id="about"></a>
      <h2 class="info__title info__title_main titleH2">
        О группе компаний СервисГаз
      </h2>
      <ul class="companyPage__list">
        <li class="companyPage__item">
          <img
            src="../../assets/images/company/company-descr1.jpg"
            alt="Предприятие"
            class="companyPage__img"
          />
          <div class="companyPage__descr">
            <p>
              Группа компаний «СервисГаз» (город Ульяновск) входит в десятку
              крупнейших российских производителей бытовых отопительных котлов и
              аппаратов, а также систем безопасности газового оборудования.
            </p>
            <p>
              За производство отвечает головное предприятие ООО «СервисГаз».
              Основное направление деятельности предприятия – производство
              отопительных котлов и аппаратов, газовых горелок, блоков
              управления и газогорелочных устройств. Сервиз газ – предприятие
              полного цикла производства (более 20 производственных участков,
              более 200 единиц оборудования) Имеет 12 патентов на изобретения.
            </p>
          </div>
        </li>
        <li class="companyPage__item">
          <div class="companyPage__descr">
            <p>
              ...
              лидирующее позиции на рынке уже более 25 лет.
            </p>
            <p>
              В 2019 году предприятием был произведен полумиллионный котел! Вся
              продукция предприятия «СервисГаз» проходит многократный контроль в
              процессе производства, она надежна и проста в эксплуатации.
              Качество изделий подтверждено сертификатом соответствия Единого
              Таможенного союза. Производство сертифицировано по стандарту
              качества ГОСТ ISO 9001-2011.
            </p>
          </div>
          <img
            src="../../assets/images/company/company-descr2.jpg"
            alt="Предприятие"
            class="companyPage__img companyPage__img_main"
          />
          <img
            src="../../assets/images/company/company-descr2-320.jpg"
            alt="Предприятие"
            class="companyPage__img companyPage__img_320"
          />
        </li>
        <li class="companyPage__item">
          <img
            src="../../assets/images/company/company-descr3.jpg"
            alt="Продукция"
            class="companyPage__img"
          />
          <div class="companyPage__descr">
            <p>
              ...
              головном предприятии «СервисГаз», а также отвечает за реализацию и
              продвижение оборудования одного из направлений предприятия –
              торговой марки «BURAN».
            </p>
            <p>
              Продукция торговой марки «BURAN», а именно: стальные отопительные
              котлы BURAN КСГ/КСГВ, парапетные котлы BURAN Parapet КСГЗ,
              аппараты газовые водогрейные BURAN АОГВ/АКГВ – реализуются
              исключительно через компанию ООО «НПП Гидросистема». Компания
              имеет развитую дилерскую сеть во многих регионах России и странах
              СНГ, где оборудование марки «BURAN» хорошо известно и пользуется
        ...
        <li class="companyPage__item">
          <div class="companyPage__descr">
            <p>
              «Исключительная лицензия на использование товарных знаков
              «БУРАН/BURAN» принадлежит Обществу с ограниченной ответственностью
              «СервисГаз» г. Ульяновск. Незаконное использование торговых знаков
              «БУРАН/BURAN» может повлечь за собой как административную, так и
              уголовную ответственность, которая регулируется ст. 180 УК РФ.
            </p>
          </div>
          <img
            src="../../assets/images/company/company-descr4.2.jpg"
            alt="Лицензия"
            class="companyPage__img companyPage__img_main"
          />
          <img
            src="../../assets/images/company/company-descr4.2-320.jpg"
            alt="Лицензия"
            class="companyPage__img companyPage__img_320"
          />
          <img
            src="../../assets/images/company/company-descr4.jpg"
            alt="Производство"
            class="companyPage__img"
          />
        </li>
...
@media (max-width: 1599px)
    ...
    .team
        &__item
            grid-template-columns: 223px 420px
        ...
        .employeeSlider
            ...
            &__arrow
                ...
                &-right
                    right: 85px
        &__list
            grid-template: repeat(2, 250px)/repeat(2, 155px)
            column-gap: 115px
            justify-content: center
        &__item
            &:nth-child(5),
...
@media (max-width: 1439px)
    .info
        &__wrapper
            grid-template-columns: 175px 114px 808px
        &__logo
            max-width: 150px
        &__numbers
            margin-left: 57px
    ...
    .team
        ...
        &__title
            ...
            line-height: 28px
        &__item
            grid-template-columns: 169px 352px
            column-gap: 20px
            &-photo
                max-width: 169px
                max-height: 222px
    ...
    .employee
        padding-top: 67px
        &__list
            grid-template: repeat(1, 250px)/repeat(2, 155px)
            column-gap: 56px
        &__item
            &:nth-child(3),
            &:nth-child(4)
...
@media (max-width: 1199px)
    .info
        &__wrapper
            grid-template-columns: 137px 114px 609px
        &__logo
            max-width: 137px
            &-wrapper
                margin-top: 15px
    ...
    .team
        &__wrapper
            width: 100%
        &__item
            grid-template-columns: 169px 662px
    ...
    .employee
        ...
        &__wrapper
            ...
            background-color: $lightblueB
        &__list
            grid-template: repeat(1, 250px)/repeat(4, 155px)
        &__item
            &:nth-child(3),
            &:nth-child(4)
                display: block
...
@media (max-width: 991px)
    .info
        &__wrapper
            grid-template-columns: 137px 539px
        &__logo
            &-wrapper
                order: 1
        &__numbers
    ...
    .team
        &__item
            grid-template-columns: 169px 520px

    .employee
        .container
            margin-left: 30px
        &__list
            grid-template: repeat(1, 250px)/repeat(3, 155px)
        &__item
            &:nth-child(4)
                display: none
...
@media (max-width: 767px)
    ...
    .team
        &__item
            grid-template-columns: 169px 345px
...
@media (max-width: 575px)
    ...
    .employee
        .container
            margin-left: 20px
        &__list
            grid-template: repeat(1, 250px) / repeat(1, 155px)
        &__item
            &:nth-child(2)
                display: none
    .news
