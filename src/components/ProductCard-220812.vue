    ...
    <div class="product__top-box">
      ...
      <div class="product__textbox">
        <h3 class="product__name">
          ...
          <span class="product__feature2">{{ product.space }} м2</span>
        </h3>
        <p class="product__description">{{ product.typeName }}</p>
        <p class="product__description">{{ product.power }} кВт</p>
      </div>
    </div>
    <div class="product__bottom-box">
      <div class="bottom-box-l">
        <button @click="openModal" class="product__btn-order">Заказать</button>
        <RouterLink class="product__link" to="/contacts"  >Где купить?</RouterLink>
      </div>
